...
# Source: 
# - https://ericmjl.github.io/data-science-bootstrap-notes/install-homebrew-on-your-machine/
# - https://raw.githubusercontent.com/Homebrew/install/HEAD/install.sh
#
# Addtions for later dotdrop usage:
# - Install coreutils and libmagic homebrew packages
# - Install pyenv homebrew package
...
ohai "Homebrew Installation successful!"
echo
